...
public class Despesa {
	...
	private LocalDate dtVenc = LocalDate.of(0,0,0);
	...
	public String toString() {
		return "Despesa [parcela=" + parcela + ", idUsuario=" + idUsuario + ", id=" + id + ", valorDespesa="
				+ valorDespesa + ", descDespesa=" + descDespesa + ", catDespesa=" + catDespesa + ", prioridade=" + prioridade + ", dtVenc=" + dtVenc + ", status=" + status + "]";
	}
